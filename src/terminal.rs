...
use crate::{
    command_list::draw_command_list, editor_draw_rows, editor_scroll, DEFAULT_COMMAND_PLACEHOLDER,
    EditorMode,
};
...
impl Terminal {
    ...
    pub fn render_frame(
        ...
        self.draw_command_line(number_of_columns, command_line)?;
    ...
    fn draw_command_line(&mut self, number_of_columns: u16, command_line: &str) -> io::Result<()> {
        queue!(&mut self.buffer, MoveTo(0, 0), Clear(ClearType::CurrentLine))?;
